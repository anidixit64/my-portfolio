...
import CV from "../data/Aniket_Dixit_Resume.pdf";
		...
		<div className='hero-section' name='home' id='home'>
			...
			<motion.div
				...
				<p className='hero-desc'>
					<span className='hero-desc-sub'>Software Engineer | Linguistics | Machine Learning | Database Management | CS and Linguistics @ UMich.</span>
				</p>
			</motion.div>
			<motion.span
				...
				initial='hidden'
				whileInView='visible'>
				<a href={CV} download='Aniket_Dixit_Resume' className='hero-contact'>
